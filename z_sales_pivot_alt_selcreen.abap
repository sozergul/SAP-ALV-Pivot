...
DATA: gt_functions  TYPE TABLE OF ty_functions WITH EMPTY KEY.
  ...
  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(34) psvz." FOR FIELD p_varid.
  ...
  SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-001.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(31) ptp FOR FIELD p_term.
  ...
  SELECTION-SCREEN BEGIN OF BLOCK b4 WITH FRAME TITLE TEXT-004.
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(31) prv FOR FIELD p_mein.
      PARAMETERS : p_mein TYPE vbap-vrkme.
      SELECTION-SCREEN COMMENT 39(1) l_spa2 .
      PARAMETERS : p_cprc AS CHECKBOX MODIF ID c0 .
      SELECTION-SCREEN COMMENT 64(30) pcp FOR FIELD p_cprc.
    SELECTION-SCREEN END OF LINE.
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(31) pw1 FOR FIELD p_wahr.
      PARAMETERS :  p_wahr TYPE vbak-waerk .
      SELECTION-SCREEN COMMENT 41(10) pc1 FOR FIELD p_cur1.
      PARAMETERS :  p_cur1(16) AS LISTBOX VISIBLE LENGTH 16 MODIF ID b1 .
    SELECTION-SCREEN END   OF LINE .
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(31) pw2 FOR FIELD p_wah2.
      PARAMETERS :  p_wah2 TYPE vbak-waerk .
      SELECTION-SCREEN COMMENT 41(10) pc2 FOR FIELD p_cur2.
      PARAMETERS :  p_cur2(16) AS LISTBOX VISIBLE LENGTH 16 MODIF ID b1 .
    SELECTION-SCREEN END   OF LINE .
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(31) pdm FOR FIELD p_layo.
      PARAMETERS :  p_layo TYPE disvariant-variant  MODIF ID m1.
...
SELECTION-SCREEN BEGIN OF SCREEN 1200 AS SUBSCREEN.
  ...
  " Grup
  SELECTION-SCREEN BEGIN OF BLOCK c3 WITH FRAME TITLE TEXT-007.
  SELECTION-SCREEN BEGIN OF LINE.
  ...
  SELECTION-SCREEN BEGIN OF BLOCK c1 WITH FRAME TITLE TEXT-005.
    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT (22) ptr FOR FIELD p_disp.
      PARAMETERS: p_disp AS LISTBOX VISIBLE LENGTH 12 DEFAULT '1' USER-COMMAND srt MODIF ID d1.
      SELECTION-SCREEN COMMENT (14) l_spx8 .
      PARAMETERS: p_colr  AS CHECKBOX .
      SELECTION-SCREEN COMMENT (48) pco FOR FIELD p_colr.
    SELECTION-SCREEN END   OF LINE .

    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT (22) psr FOR FIELD p_sort.
      PARAMETERS : p_sort AS LISTBOX VISIBLE LENGTH 22 USER-COMMAND srt MODIF ID d1.
      SELECTION-SCREEN COMMENT (4) l_spx3 .
      PARAMETERS : p_asde AS CHECKBOX MODIF ID m3 .
      SELECTION-SCREEN COMMENT 60(32) pad FOR FIELD p_asde.
    SELECTION-SCREEN END OF LINE.

    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT (22) plo FOR FIELD p_nolb.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      ...
      SELECTION-SCREEN COMMENT (49) poc FOR FIELD p_ocds .
    SELECTION-SCREEN END   OF LINE .

    SELECTION-SCREEN BEGIN OF LINE.
      PARAMETERS :  p_cdec  AS CHECKBOX .
      SELECTION-SCREEN COMMENT (48) pcd FOR FIELD p_cdec .
      PARAMETERS :  p_zero  AS CHECKBOX.
      SELECTION-SCREEN COMMENT  (49) pzr FOR FIELD p_zero.
    SELECTION-SCREEN END   OF LINE .
  SELECTION-SCREEN END OF BLOCK c1.

  " Aktarım
  SELECTION-SCREEN BEGIN OF BLOCK c4 WITH FRAME TITLE TEXT-008.
    SELECTION-SCREEN BEGIN OF LINE.
      PARAMETERS : p_mail AS CHECKBOX DEFAULT ' ' USER-COMMAND srt.
      SELECTION-SCREEN COMMENT 3(17) pml FOR FIELD p_mlto.
      SELECT-OPTIONS : p_mlto FOR adr6-smtp_addr VISIBLE LENGTH 48 NO INTERVALS.
      SELECTION-SCREEN COMMENT 50(1) l_spa20.
      PARAMETERS: p_body  AS CHECKBOX DEFAULT ' ' MODIF ID bd.
      SELECTION-SCREEN COMMENT 77(40) pbd FOR FIELD p_body.
    SELECTION-SCREEN END OF LINE.

    SELECTION-SCREEN BEGIN OF LINE.
      SELECTION-SCREEN COMMENT 1(22) psb FOR FIELD p_subj.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      PARAMETERS : p_excl  AS CHECKBOX DEFAULT ' ' USER-COMMAND srt .
      SELECTION-SCREEN COMMENT 3(20) pex FOR FIELD p_path.
    ...
    SELECTION-SCREEN BEGIN OF LINE.
      ...
      SELECTION-SCREEN COMMENT 3(20) pws FOR FIELD p_xval.
      PARAMETERS : p_xval AS LISTBOX VISIBLE LENGTH 22 MODIF ID c1 .
      SELECTION-SCREEN COMMENT (1) poz1.
    SELECTION-SCREEN END OF LINE .

    SELECTION-SCREEN BEGIN OF LINE.
      PARAMETERS : p_oprp AS CHECKBOX DEFAULT 'X' .
      SELECTION-SCREEN COMMENT (20) pdr FOR FIELD p_oprp.
      PARAMETERS : p_opxl AS CHECKBOX DEFAULT ' ' MODIF ID e1 .
      SELECTION-SCREEN COMMENT 30(20) pox FOR FIELD p_opxl.
    SELECTION-SCREEN END OF LINE .
...
SELECTION-SCREEN BEGIN OF SCREEN 2100 AS SUBSCREEN.
  ...
  SELECT-OPTIONS: s_lfbel  FOR lips-vbeln,
                  ...
                  s_fkbel  FOR vbrk-vbeln,
                  s_belnr  FOR vbrk-belnr,
                  s_augbl  FOR bsad-augbl.
  PARAMETERS:     p_bstkd TYPE vbkd-bstkd.
  SELECT-OPTIONS: s_augru  FOR vbak-augru,
                  s_abgru  FOR vbap-abgru,
                  s_ernam  FOR vbap-ernam,
                  s_erdat  FOR vbap-erdat,
                  s_vgtyp  FOR vbap-vgtyp,
                  s_lfsta  FOR vbap-lfsta,
                  s_wbsta  FOR lips-wbsta,
                  s_fstat  FOR vbrk-vf_status.
  SELECT-OPTIONS: s_zterm  FOR vbkd-zterm,
                  s_vkgrp  FOR vbak-vkgrp.
  SELECT-OPTIONS: s_inco1  FOR vbkd-inco1,
...
SELECTION-SCREEN END   OF SCREEN 2100.
  ...
  DATA sob TYPE string.
  DATA sop TYPE string.
  DATA slb TYPE string.
  DATA smb TYPE string.
  DATA sfb TYPE string.
  DATA snb TYPE string.
  DATA sab TYPE string.
  DATA ssk TYPE string.
  DATA sau TYPE string.
  DATA sag TYPE string.
  DATA ocr TYPE string.
  DATA ocd TYPE string.
  DATA svt TYPE string.
...
*     TODO: Error Handling
  ...
  METHOD set_text_variables.
    ...
    l_obrx = VALUE #( gt_textlist[ sym = 'L16' ]-text OPTIONAL ).
    l_obr0 = '('.
    l_cbr0 = ')'.
    l_obr1 = '('.
    l_obr2 = '('.
...
*           TODO: Error Handling
    ...
    IF p_excl EQ 'X'.
      ...
      IF p_excl EQ 'X' AND lv_xstring IS NOT INITIAL AND gv_gui_available = abap_true.
        ...
        IF sy-subrc <> 0.
           IF sy-subrc = 15.
             MESSAGE VALUE #( gt_textlist[ sym = 'A17' ]-text OPTIONAL ) TYPE 'S' DISPLAY LIKE 'E'.
           ELSE.
...
FORM set_text_tr.
  ...
  APPEND VALUE #( sym = 'A17' text = 'Excel dosya kaydedebilmek için GUI seçeneklerinde güvenlik durumunu "Kapalı" hale getirmelisiniz' ) TO gt_textlist.
  ...
  APPEND VALUE #( sym = 'PEX' text = 'Excel''e kaydet' ) TO gt_textlist.
  ...
  APPEND VALUE #( sym = 'PWS' text = 'Çalışma sayfaları' ) TO gt_textlist.
...
FORM set_text_en.
  ...
  APPEND VALUE #( sym = 'A17' text = 'To save an Excel file, you must set the security status to "Disabled" in the GUI options.' ) TO gt_textlist.
  ...
  APPEND VALUE #( sym = 'PEX' text = 'Save to Excel' ) TO gt_textlist.
...
FORM set_text_de.
  ...
  APPEND VALUE #( sym = 'A17' text = 'Um eine Excel-Datei zu speichern, müssen Sie den Sicherheitsstatus in den GUI-Optionen auf „Deaktiviert“ setzen.' ) TO gt_textlist.
  ...
  APPEND VALUE #( sym = 'PEX' text = 'In Excel speichern' ) TO gt_textlist.
  ...
  APPEND VALUE #( sym = 'PWS' text = 'Arbeitsblätter' ) TO gt_textlist.
